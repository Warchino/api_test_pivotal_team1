...
Feature: Manage memberships in an account
  ...
  Scenario: Add a member in an account with an email, name and initials
  ...
  @read_account @delete_data
  Scenario: Add a member in an account with an email, name and admin privileges
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Add a member in an account with an id and admin privileges
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Add a member in an account with an id and create project privileges
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
