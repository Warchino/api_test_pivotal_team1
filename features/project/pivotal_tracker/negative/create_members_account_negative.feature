...
Feature: negative tests for update a member in an account
  ...
  Scenario: Update  membership with only name
  ...
  @read_account @delete_data
  Scenario: Update a membership with a non-email word in email field
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  Scenario: Update a membership with different name than name assigned to email
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Update a membership with very long name
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data @bug
  Scenario: Update a membership with initials greater than 10 characters
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Update a membership with created_at field wrong
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Update a membership with a non-existent person id
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Update a membership with a wrong person_id type
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Update a membership with person_id and email
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
  ...
  @read_account @delete_data
  Scenario: Update a membership with wrong params in the body request
    Given I set up a "POST" request to "/accounts/{account_id}/memberships" endpoint
    When I set up the data
    """
      {
